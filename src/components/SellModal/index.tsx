...
import { getSellPriceAfterFeeAbi, sellAbi } from "@/dolphin/abis";
...
import { Button, Dialog, Link, TextField } from "@radix-ui/themes";
...
export default function SellModal({
    ...
    const {
        ...
        getSellPriceAfterFeeAbi,
        function_names.getSellPriceAfterFee
    )
    const {
        hash,
        error,
